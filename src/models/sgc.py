...
from strn_and_rbstness.aggregation import chunked_message_and_aggregate
from strn_and_rbstness.helper.utils import sparse_tensor_to_tuple, tuple_to_sparse_tensor
from strn_and_rbstness.models.gcn import GCN
...
class ChainableSGConv(SGConv):
    """Simple extension to allow the use of `nn.Sequential` with `SGConv`. The 
    arguments are wrapped as a Tuple/List are are expanded for Pytorch Geometric.
